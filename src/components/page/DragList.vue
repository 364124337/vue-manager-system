<template>
    <section class="main">
        ...
        <div class="drag-box-left">
            ...
            <div class="drag-list" draggable="true" v-for="list in data1" :data-id="list.id" @dragstart="dragstartEvent" @dragend="dragendEvent"
        ...
        <div class="drag-box-right">
            ...
            <div class="drag-list" draggable="true" v-for="list in data2" :data-id="list.id" @dragstart="dragstartEvent" @dragend="dragendEvent"
             @dragenter="dragenterEvent">
                {{list.title}}
            </div>
        </div>
